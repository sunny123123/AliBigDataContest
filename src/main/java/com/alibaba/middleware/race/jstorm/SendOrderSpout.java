...
public class SendOrderSpout implements IRichSpout,MessageListenerConcurrently{
	
	Logger LOG = LoggerFactory.getLogger(SendOrderSpout.class); 
	...
	public void nextTuple() {
		...
		try {
			OrderStream order = orderQueue.take();
			this.collector.emit(new Values(order));
